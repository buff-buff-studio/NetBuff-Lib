...
namespace NetBuff.Relays
{
    public static class RelayUtils
    {
        ...
        public static RelayServerData HostRelayData(Allocation allocation,
            RelayServerEndpoint.NetworkOptions connectionType)
        {
        ...
        /// <summary>
        /// Convert the byte array to a RelayAllocationId.
        /// </summary>
        /// <param name="allocationIdBytes"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Convert the byte array to a RelayConnectionData.
        /// </summary>
        ...
        /// <summary>
        /// Convert the byte array to a RelayHMACKey.
        /// </summary>
        ...
        /// <summary>
        /// Get the endpoint for the connection type.
        /// </summary>
